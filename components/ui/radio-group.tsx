...
function RadioGroup({ className, ...props }: RadioGroupPrimitive.Props) {
  return (
    <RadioGroupPrimitive
      ...
      className={cn("grid w-full cursor-pointer gap-3", className)}
      {...props}
    />
  )
}
